...
<body>
  <header>
    <div class="head-left"><img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_74x24dp.png" alt="google"> </div>
    <div class="head-right"> <h2>Privacy e termini</h2> </div>
  </header>
  <section class="section-head">
    <div class="pr"> <p>Introduzione</p> </div>
    <div ><p>Norme sulla privacy</p></div>
    <div><p>Termini di servizio</p></div>
    <div><p>Tecnologie</p></div>
    <div class="light"><p>Domande frequenti</p></div>
    <div class="mail">matteraivan@aaaaa.it</div>
  </section>
  <main>
